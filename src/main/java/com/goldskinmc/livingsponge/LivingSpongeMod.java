...
public final class LivingSpongeMod {
    ...
    private void addCreativeTabContents(final BuildCreativeModeTabContentsEvent event) {
        if (event.getTabKey() == CreativeModeTabs.FUNCTIONAL_BLOCKS) {
            ...
            event.accept(LivingSpongeItems.SURFACE_WALL_FORMING_LIVING_SPONGE.get());
            event.accept(LivingSpongeItems.EXPANDED_SURFACE_WALL_FORMING_LIVING_SPONGE.get());
            event.accept(LivingSpongeItems.VAST_SURFACE_WALL_FORMING_LIVING_SPONGE.get());
            ...
            event.accept(LivingSpongeItems.MAGMA_SURFACE_WALL_FORMING_LIVING_SPONGE.get());
            event.accept(LivingSpongeItems.EXPANDED_MAGMA_SURFACE_WALL_FORMING_LIVING_SPONGE.get());
            event.accept(LivingSpongeItems.VAST_MAGMA_SURFACE_WALL_FORMING_LIVING_SPONGE.get());
            ...
            event.accept(LivingSpongeItems.MAGMA_SURFACE_FRUITING_LIVING_SPONGE.get());
            event.accept(LivingSpongeItems.EXPANDED_MAGMA_SURFACE_FRUITING_LIVING_SPONGE.get());
            event.accept(LivingSpongeItems.VAST_MAGMA_SURFACE_FRUITING_LIVING_SPONGE.get());
